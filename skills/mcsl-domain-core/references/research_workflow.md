...
- `MCSL_AUTOMATION_REPO_PATH`: Playwright automation specs/POMs/helpers
- `STOREPEPSAAS_SERVER_PATH`: shared StorePep server implementation
- `STOREPEPSAAS_CLIENT_PATH`: StorePep/MCSL client implementation
...
- official MCSL/Shopify/PluginHive behavior is needed and not present locally
...
- specify evidence source: UI, request log, response log, rate log, document bundle, Print Documents PDF
