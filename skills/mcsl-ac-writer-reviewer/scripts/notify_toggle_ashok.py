...
Usage:
    PYTHONPATH=. .venv/bin/python skills/mcsl-ac-writer-reviewer/scripts/notify_toggle_ashok.py \
...
def _resolve_store(cli_store: str) -> str:
    ...
    try:
        ...
        auto_path = getattr(config, "MCSL_AUTOMATION_REPO_PATH", "") or ""
        if auto_path:
...
def main() -> int:
    ...
    parser.add_argument("--store", default="", help="Shopify store name, for example kee-mcsl-qa.")
